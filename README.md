~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
PLEASE READ! This is only an archive, which will sooner or later become OBSOLETE. For the currently maintained repository, head to https://github.com/AntiMicro/antimicro

This is a backup of the latest versions of antimicro plus the source code, which were removed from https://github.com/Ryochan7/antimicro
I have downgraded SDL2.dll in the Windows releases from 2.0.4 to 2.0.3 (using msi2xml for the .msi files). It had to be done because SDL 2.0.4 broke DInput controllers detection.
Backup of some pages (such as the wiki): http://www.mediafire.com/download/hla0doflg49th41/AntimicroPagesBackup.zip
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
